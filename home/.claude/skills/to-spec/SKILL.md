---
name: to-spec
description: Turn the current conversation into a spec and publish it to the local Markdown issue tracker — no interview, just synthesis of what you've already discussed.
...
3. Write the spec using the template below, then publish it to `.scratch/<feature-slug>/PRD.md` with `Status: ready-for-agent` before the first heading. No additional triage is needed.
