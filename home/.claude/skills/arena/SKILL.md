...
3. Pick the runners. Default 4: `opus`, `opus`, `sonnet`, and `fable`. Spawn more when the arena covers multiple design directions. Same model N times when the work is generation-bound rather than judgment-sensitive.
